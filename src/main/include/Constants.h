...
namespace CONSTANTS
{
  ...
  namespace MANIPULATOR_STATES
  {
    ...
    constexpr ManipulatorState L2{0_tr, -10.25_tr}; // 18.4 follow-through
    constexpr ManipulatorState L3{11.58_tr, -9.9_tr};
    ...
    constexpr ManipulatorState ALGAE_L3{22.20_tr, -16.80_tr};
